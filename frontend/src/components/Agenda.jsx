...
const days = [
	{
		...
		tab: 'Dzień I · Ślub',
		date: dates.wedding,
		events: timelineWedding,
	},
	{
		key: 'after',
		tab: 'Dzień II · Poprawiny',
		date: dates.afterParty,
		events: timelineAfterParty,
	},
];
	...
	return (
		...
		>
			<path
				...
				d='M4 16V6a2 2 0 012-2h9a2 2 0 012 2v10M4 16h13M4 16v2a1 1 0 001 1h1a1 1 0 001-1v-2m10-2V9h2.5a1 1 0 01.8.4l1.5 2a1 1 0 01.2.6v2m-6 0h6m0 0v2a1 1 0 01-1 1h-1a1 1 0 01-1-1v-2M7 8h8M7 12h.01M13 12h.01'
			/>
		</svg>
	);
}
	...
	return (
		...
		>
			...
			<div className='flex-1 pl-5 py-5 border-b border-lb-champagne/10'>
				...
				{event.note && (
					<p className='text-lb-cream/40 text-sm font-light italic mt-1'>
						{event.note}
					</p>
				)}
			</div>
...
export default function Agenda() {
	...
	return (
		<section
			id='agenda'
			className='relative py-24 px-4 bg-lb-dark overflow-hidden'
		>
			...
			<div className='relative max-w-3xl mx-auto'>
				...
				>
					...
					<p className='text-lb-cream/45 text-sm font-light mt-6 max-w-md mx-auto'>
						Transfery autokarem są zapewnione w obie strony, odbiór z hotelu i
						powrót po zabawie.
					</p>
				</motion.div>
