...
export default function Podziekowanie() {
	return (
		<section
			id='podziekowanie'
			className='relative py-28 md:py-36 px-4 bg-lb-dark text-lb-cream overflow-hidden'
		>
			<div
			...
			>
				...
				<div className='mt-12 mb-3 font-serif italic text-lb-cream'>
					<span className='block text-4xl md:text-5xl leading-tight'>
						{couple.bride}
					</span>
					<span className='block text-lb-champagne text-2xl md:text-3xl font-light my-1'>
						&amp;
					</span>
					<span className='block text-4xl md:text-5xl leading-tight'>
						{couple.groom}
