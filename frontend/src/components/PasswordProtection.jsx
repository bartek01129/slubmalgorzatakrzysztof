...
export default function PasswordProtection({ onSuccess }) {
	...
	return (
		...
		>
			{/* Lewy panel — ciemny, dekoracyjny (tylko desktop) */}
			...
			{/* Prawy panel — formularz (na mobilnym całe tło = lb-cream, lekki beż strony) */}
			<div className='flex-1 flex items-center justify-center px-8'>
				...
				>
					...
					<p className='lb-eyebrow mb-8'>Prywatna strona ślubna</p>

					<h3 className='font-serif italic text-3xl text-lb-dark mb-2'>
						Witajcie
					</h3>
					<p className='text-sm text-lb-text/50 font-light mb-9'>
						Wpiszcie hasło, aby zobaczyć harmonogram naszego dnia
					</p>
