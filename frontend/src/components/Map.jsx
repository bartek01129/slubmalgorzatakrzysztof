				...
				<div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch'>
					{locations.map((loc) => (
						...
						>
							...
							<h3 className='text-2xl font-serif italic text-lb-dark'>
								{loc.title}
							</h3>
							...
							{/* KARTA INFORMACYJNA */}
							<div
								className='bg-white p-6 shadow-lb-softer min-h-[160px] flex flex-col'
							...
							>
								<div className='flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 h-full'>
									<div className='flex-1'>
										...
										<p className='text-sm text-lb-text/70 mt-1'>
											{loc.address}
										</p>
